...
If you are not familiar with R, I suggest you download the solutions notebook written in RMarkdown. If you open the file in RStudio, you can then follow along and run the solutions code line-by-line. Alternatively, if you just want to read the sample code, you can view the solution here. 
